 ...
 * @author Lailson-pc
 */
public class ConsTurista extends javax.swing.JFrame {
    
    ArrayList lista = new ArrayList();

    /**
     * Creates new form ConsTurista
     */
    public ConsTurista() {
        initComponents();
        atualizaLista("", "");
    ...
    private void initComponents() {
        ...
        jLabel23.setText("Consultar Clientes Turismo");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jSeparator6, javax.swing.GroupLayout.DEFAULT_SIZE, 825, Short.MAX_VALUE)
                    .addGroup(jPanel7Layout.createSequentialGroup()
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        ...
        if (o != null){
            ClienteTurismo p = (ClienteTurismo)o;
            new CadastrarCliente(p, 1).setVisible(true);
        }
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        if (o != null){
            ...
            try {
                ...
                Logger.getLogger(ConsTurista.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(ConsTurista.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        JOptionPane.showMessageDialog(rootPane, "Turista Excluído.");
        atualizaLista("", "");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsTurista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsTurista().setVisible(true);
            }
        });
    }
    ...
    private void atualizaLista(String cpf, String nome) {
        ...
        //v = new Veiculo();
        String mensagem = "";
        String[] nomesColunas = {"Nome", "RG", "CPF", "Endereço", "Nº", "Cidade", "Estado", "Telefone", "Data Nascimento"};
        if (cpf.length() > 0){
            lista = new ArrayList(ClienteTurismo.consultarTuristaCpf(cpf));
            mensagem = "Não existem Clientes de Escolar com CPF "+ cpf +" cadastrados.";
        }else if(nome.length() > 0){
            lista = new ArrayList(ClienteTurismo.consultarTuristaNome(nome));

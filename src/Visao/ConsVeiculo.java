 ...
 * @author lailson
 */
public class ConsVeiculo extends javax.swing.JFrame {
    
    Veiculo v = new Veiculo();
    ArrayList lista = new ArrayList();

    /**
     * Creates new form ConsVeiculo
     */
    public ConsVeiculo() {
        initComponents();
        atualizaLista();
    ...
    private void initComponents() {
        ...
        jLabel23.setText("Consultar Veículo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsVeiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsVeiculo().setVisible(true);
            }
        });
    }
    ...
    private void atualizaListaPlaca(String placa) {
        ...
        tabela.setModel(modelo);
        if(lista.isEmpty()){
            JOptionPane.showMessageDialog(this, "Não foram encontrados veículos com a placa: " + placa);
            atualizaLista();
        }
